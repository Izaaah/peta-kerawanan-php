...
Route::middleware(['auth', 'verified', 'role.redirect'])->prefix('super-admin')->name('super-admin.')->group(function () {
    ...
    // Note: Input routes removed - input folder no longer exists in super-admin
    // Note: data-pendukung, data-lanjutan, data-kasus routes removed - views don't exist in super-admin
...
Route::middleware(['auth', 'verified', 'role.redirect'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/api/debug-kabupaten', [DataDesaController::class, 'debugKabupaten'])->name('admin.api.debug.kabupaten');
...
//     return view('map.map-tkp-residivis');
// })->name('peta-tkp-residivis');
// Note: File map-tkp-residivis.blade.php tidak ditemukan, route dinonaktifkan
