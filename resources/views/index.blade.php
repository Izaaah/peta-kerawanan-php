...
<body>
    <header class="bg-blue-700 text-white px-6 py-4 flex justify-between items-center rounded-none border-b border-gray-300 fixed">
        ...
        <nav class="space-x-4">
          ...
          <a href="#statistik" class="hover:underline">Statistik</a>
          <a href="#peta" class="hover:underline">Laporan</a>
          <a href="#kontak" class="hover:underline">Kontak</a>
        </nav>
      </header>
      <section class="bg-blue-700 text-white text-center py-16 px-4 rounded-b-xl">
