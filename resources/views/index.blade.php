        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div class="col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div class="bg-gradient-to-b from-red-700 to-red-900 rounded-2xl p-6 shadow">
                ...
                <!-- big vision card -->
                <div
                    class="bg-gradient-to-b from-red-700 to-red-900 rounded-2xl p-8 flex flex-col items-center justify-center text-center shadow relative">
