...
<div class="container-fluid px-4 py-8 min-h-screen bg-gray-50 dark:bg-gray-900">
    <div class="flex flex-col md:flex-row gap-8">

        <!-- Main Content -->
        <main class="flex-1 mt-[90px]">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-2">Chart Jaringan Narkoba</h1>
                <p class="text-gray-500 dark:text-gray-300 mb-6">Buat dan visualisasikan jaringan pelaku narkoba secara interaktif.</p>

                <form x-data="chartJaringan" x-init="init" class="space-y-8">
                    <!-- Node Input Section -->
                    <section class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-4">
                        <h2 class="text-md font-semibold mb-3 text-gray-700 dark:text-gray-200">Tambah Node Jaringan</h2>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nama/ID Pelaku</label>
                                <input type="text" x-model="newNodeName" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white" placeholder="Contoh: Bandar A, Kurir B">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tipe Pelaku</label>
                                <select x-model="newNodeType" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white">
                    ...
                    <!-- Nodes List -->
                    <section class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-4">
                        <h2 class="text-md font-semibold mb-3 text-gray-700 dark:text-gray-200">Daftar Node Jaringan</h2>
                        <div class="space-y-3">
                            <template x-for="(node, index) in nodes" :key="node.id">
                                <div class="flex items-center space-x-4 p-3 bg-white dark:bg-gray-800 rounded-lg border">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <input type="text" x-model="node.name" class="px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" placeholder="Nama node">
                                        <select x-model="node.type" class="px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                    ...
                    <!-- Connection Section -->
                    <section class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-4">
                        <h2 class="text-md font-semibold mb-3 text-gray-700 dark:text-gray-200">Hubungan Antar Node</h2>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Dari Node</label>
                                <select x-model="connectionFrom" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Ke Node</label>
                                <select x-model="connectionTo" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white">
                                    <option value="">Pilih node</option>
                                    <template x-for="(node, index) in nodes" :key="node.id">
                                        <option :value="index" x-text="node.name || 'Node ' + (index + 1)"></option>
                                    </template>
                    ...
                    <section class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-4">
                        <h2 class="text-md font-semibold mb-3 text-gray-700 dark:text-gray-200">Preview Visualisasi Jaringan</h2>
                    ...
                    <div class="flex justify-end space-x-4">
                        <button type="button" @click="resetAll" class="px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-200">
