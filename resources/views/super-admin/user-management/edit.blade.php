                            ...
                            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                <div class="p-6">
                                    <div class="flex justify-between items-center mb-6">
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Edit Pengguna:
                                            {{ $user->name }}</h3>
                                    ...
                                    <form action="{{ route('super-admin.user-management.update', $user->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                <label for="email"
                                                    ...
                                                    (Biarkan kosong untuk menjaga email saat ini)</label>
                                            ...
                                            <div>
                                                <label for="password"
                                                    ...
                                                    (Biarkan kosong untuk menjaga password saat ini)</label>
                                            ...
                                            <div>
                                                <label for="password_confirmation"
                                                    ...
                                                    Password (Biarkan kosong untuk menjaga password saat ini)</label>
