...
@section('title', 'Data Lanjutan Penanganan')
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Data Lanjutan Penanganan</h1>
                    <p class="text-sm text-gray-600 mt-1">Kelola data lanjutan dan tindak lanjut kasus narkoba</p>
                </div>
            ...
            <div class="bg-blue-50 p-4 rounded-lg mb-6 border border-blue-200">
                <div class="flex flex-col md:flex-row gap-4 items-center">
                    <div class="flex-1">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Cari Data Lanjutan</label>
                        <div class="relative">
                            ...
                            <input type="text"
                                   id="searchLanjutan"
                                   placeholder="Masukkan nomor kasus atau jenis tindak lanjut..."
            ...
            <div class="bg-gray-50 p-4 rounded-lg mb-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Jenis Tindak Lanjut</label>
                    ...
                    <div>
                        ...
                        <select class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <option value="jenis">Jenis Tindak Lanjut</option>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    <h3 class="font-semibold text-blue-800">Total Tindak Lanjut</h3>
                    <p class="text-2xl font-bold text-blue-600">1,892</p>
                    <p class="text-sm text-blue-600">Semua data lanjutan</p>
                </div>
                <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                    <h3 class="font-semibold text-green-800">Berhasil</h3>
                    <p class="text-2xl font-bold text-green-600">1,234</p>
                    <p class="text-sm text-green-600">Tindak lanjut berhasil</p>
                </div>
                <div class="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                    <h3 class="font-semibold text-yellow-800">Sedang Berjalan</h3>
                    <p class="text-2xl font-bold text-yellow-600">456</p>
                    <p class="text-sm text-yellow-600">Dalam proses</p>
                </div>
                <div class="bg-red-50 p-4 rounded-lg border border-red-200">
                    <h3 class="font-semibold text-red-800">Gagal</h3>
                    <p class="text-2xl font-bold text-red-600">202</p>
                    <p class="text-sm text-red-600">Tindak lanjut gagal</p>
                </div>
            </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">Program Rehabilitasi</div>
                                            <div class="text-sm text-gray-500">Pusat Rehabilitasi BNN</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
            ...
            <div class="mt-6">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-700">
                        Menampilkan 1 sampai 10 dari 1,892 data
                    </div>
                    <div class="flex space-x-2">
...
<script>
    ...
    const searchInput = document.getElementById('searchLanjutan');
