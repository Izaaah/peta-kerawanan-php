...
@section('content')
    ...
    <div class="mx-auto px-2 lg:px-4 py-3">
        ...
        <form method="GET" action="{{ route('super-admin.data.lsm.index') }}" class="mb-4 flex flex-col sm:flex-row gap-2 form-responsive">
            ...
            <div class="table-responsive overflow-x-auto">
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-2 lg:px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Nama LSM</th>
                        <th class="px-2 lg:px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Ketua</th>
                        <th class="px-2 lg:px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">No. HP Ketua</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($lsmList as $index => $lsm)
                        <tr>
                                ...
                                <div class="flex flex-wrap gap-1 lg:gap-2 justify-center">
                                    ...
                                    <form action="{{ route('super-admin.data.lsm.destroy', $lsm->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-4 py-8 text-center text-gray-500 text-sm lg:text-base">Belum ada data LSM.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
