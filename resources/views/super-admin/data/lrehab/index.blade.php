...
@section('content')
    ...
    <div class="mx-auto px-2 lg:px-4 py-3">
        ...
        <form method="GET" action="{{ route('super-admin.data.lrehab.index') }}"
                        ...
                        @forelse($lrehabList as $i => $lrehab)
                            <tr>
                                ...
                                <td class="px-2 lg:px-4 py-2 text-center text-xs lg:text-sm">
                                    {{ $lrehabList->firstItem() + $i }}</td>
                                <td class="px-2 lg:px-4 py-2 text-xs lg:text-sm">{{ $lrehab->nama }}</td>
                                <td class="px-2 lg:px-4 py-2 text-xs lg:text-sm">{{ $lrehab->jenis_lrehab ?? '-' }}</td>
