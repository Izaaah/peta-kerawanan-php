        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-2">{{ $farmasi->user->name ?? '-' }}</td>
                    <td class="px-1 py-2 flex gap-2 justify-center">
                        ...
                        <form action="{{ route('super-admin.data.farmasi.destroy', $farmasi->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Yakin ingin menghapus user ini?');">
                            @csrf
                            @method('DELETE')
