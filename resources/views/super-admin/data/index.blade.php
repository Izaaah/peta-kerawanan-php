        ...
        <div id="dataCardGrid" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-8">
            ...
            <a href="{{ route('super-admin.data.individu') }}" class="block group">
                <div
                    ...
                    <div class="font-semibold text-blue-700 mb-1">Data Individu</div>
                    <div class="text-xs text-gray-500">Kelola profil individu</div>
                </div>
            </a>
            ...
            <a href="{{ route('super-admin.data.thm.index') }}" class="block group" tabindex="-1">
                <div
                    ...
                    <div class="font-semibold text-fuchsia-700 mb-1">Data Tempat Hiburan Malam</div>
                    <div class="text-xs text-gray-500">Kelola data Tempat Hiburan Malam dan manager</div>
                </div>
            </a>
            <!-- Card: Data Jaringan di Rutan dan Lapas -->
            <a href="{{ route('super-admin.data.rutanlapas.index') }}" class="block group">
                <div
                    class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-blue-400">
                    <div
                        class="w-14 h-14 flex items-center justify-center rounded-full bg-gradient-to-tr from-cyan-400 to-cyan-500 mb-3 shadow mx-auto">
