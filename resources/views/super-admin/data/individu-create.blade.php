...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addTkpFieldIfNeeded() {
        ...
        if ((lastProv.value || lastKab.value || lastKec.value || lastDesa.value || lastLokasi.value.trim() !== '') && rows.length < 10) {
            ...
            div.querySelector('.tkp-provinsi').addEventListener('change', function() { handleTkpProvinsiChange(div); });
            div.querySelector('.tkp-kabupaten').addEventListener('change', function() { handleTkpKabupatenChange(div); });
            div.querySelector('.tkp-kecamatan').addEventListener('change', function() { handleTkpKecamatanChange(div); });
            div.querySelector('.hapus-tkp-row').addEventListener('click', function() { div.remove(); });
        }
    }
    ...
    (function() {
        ...
        if (firstTkp) {
            ...
            firstTkp.querySelector('.tkp-provinsi').addEventListener('change', function() { handleTkpProvinsiChange(firstTkp); });
            firstTkp.querySelector('.tkp-kabupaten').addEventListener('change', function() { handleTkpKabupatenChange(firstTkp); });
            firstTkp.querySelector('.tkp-kecamatan').addEventListener('change', function() { handleTkpKecamatanChange(firstTkp); });
        }
    })();
        ...
        if (kabupaten) {
            fetch(`/super-admin/api/kecamatan-list?kabupaten=${encodeURIComponent(kabupaten)}`)
                ...
                .then(data => {
                    ...
                    kecamatanSelect._tkpChangeHandler = function() { handleTkpKecamatanChange(row); };
