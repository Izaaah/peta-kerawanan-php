...
@section('content')
    ...
    <div class="mx-auto px-2 lg:px-4 py-3">
        ...
        <form method="GET" action="{{ route('super-admin.data.objekvital.index') }}" class="mb-4 flex flex-col sm:flex-row gap-2 form-responsive">
            ...
            <div class="table-responsive overflow-x-auto">
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-2 lg:px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Nama Objek</th>
                        <th class="px-2 lg:px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Nama Manager</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($objekVitalList as $i => $objekVital)
                            <tr>                            <td class="px-2 lg:px-4 py-2">
                                <div class="flex flex-wrap gap-1 lg:gap-2 justify-center">
                                    <a href="{{ route('super-admin.data.objekvital.show', $objekVital->id) }}"
                                    ...
                                    <a href="{{ route('super-admin.data.objekvital.edit', $objekVital->id) }}"
                                    ...
                                    <form action="{{ route('super-admin.data.objekvital.destroy', $objekVital->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-4 py-8 text-center text-gray-500 text-sm lg:text-base">Belum ada data Objek Vital.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
