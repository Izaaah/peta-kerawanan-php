    ...
    <div class="bg-white shadow rounded p-6">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-4 py-2 text-center">{{ ($thmList->currentPage() - 1) * $thmList->perPage() + $index + 1 }}</td>
                    ...
                    <td class="px-3 py-2 flex gap-2 justify-center">
                        ...
                        <form action="{{ route('super-admin.data.thm.destroy', $thm->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Yakin ingin menghapus user ini?');">
                            @csrf
                            @method('DELETE')
