...
<div class="max-w-7xl mx-auto px-1 pt-1 pb-2">
    <div class="bg-white rounded shadow p-6">
        ...
        <div class="flex gap-2 mt-6">
            <a href="{{ route('super-admin.data.rutanlapas.index') }}" class="bg-gray-300 text-gray-800 px-4 py-2 rounded hover:bg-gray-400">Kembali</a>
            <a href="{{ route('super-admin.data.rutanlapas.edit', $rutanlapas->id) }}" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">Edit</a>
        </div>
    </div>
</div>
@endsection
