...
<div class="container mx-auto max-w-7xl px-1 pt-1 pb-2">
    ...
    <form method="GET" action="{{ route('super-admin.data.penggiat.index') }}" class="mb-4 flex gap-2">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 flex gap-2">
                        <a href="{{ route('super-admin.data.penggiat.show', $penggiat->id) }}" class="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-600 text-xs">Lihat</a>
                        <a href="{{ route('super-admin.data.penggiat.edit', $penggiat->id) }}" class="bg-yellow-500 text-white px-3 py-1 rounded hover:bg-yellow-600 text-xs">Edit</a>
                        <form action="{{ route('super-admin.data.penggiat.destroy', $penggiat->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?');" style="display:inline;">
                            @csrf
                            @method('DELETE')
