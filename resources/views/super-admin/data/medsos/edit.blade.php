...
<div class="max-w-xl mx-auto py-8">
    <div class="bg-white rounded shadow p-6">
        ...
        <form action="{{ route('data.medsos.update', $medsos->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-4">
            ...
            <div class="flex gap-2 mt-6">
                ...
                <a href="{{ route('data.medsos.index') }}" class="bg-gray-300 text-gray-800 px-4 py-2 rounded hover:bg-gray-400">Batal</a>
            </div>
        </form>
    </div>
</div>
