...
@section('content')
    ...
    <div class="mx-auto px-2 lg:px-4 py-3">
        ...
        <form method="GET" action="{{ route('super-admin.data.ekspedisi.index') }}"
                        ...
                        @forelse($ekspedisiList as $i => $ekspedisi)
                            <tr>
                                <td class="px-2 lg:px-4 py-2 text-center text-xs lg:text-sm">
                                    {{ $ekspedisiList->firstItem() + $i }}</td>
                                <td class="px-2 lg:px-4 py-2 text-xs lg:text-sm capitalize">{{ $ekspedisi->nama }}</td>
                                <td class="px-2 lg:px-4 py-2 text-xs lg:text-sm capitalize">{{ $ekspedisi->manager }}</td>
