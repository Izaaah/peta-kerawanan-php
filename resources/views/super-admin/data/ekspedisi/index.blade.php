...
<div class="container max-w-7xl mx-auto px-1 pt-1 pb-2">
    <div class="flex justify-between items-center mb-6">
        ...
        {{-- <a href="{{ route('super-admin.data.ekspedisi.create') }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded hover:bg-blue-700">
            <i class="fas fa-plus mr-2"></i>Tambah Ekspedisi
        </a> --}}
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-1 py-2 flex gap-2 justify-center">
                        ...
                        <form action="{{ route('super-admin.data.ekspedisi.destroy', $ekspedisi->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Yakin ingin menghapus user ini?');">
                            @csrf
                            @method('DELETE')
