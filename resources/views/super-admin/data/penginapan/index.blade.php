...
@section('content')
    ...
    <div class="mx-auto px-2 lg:px-4 py-3">
        ...
        @endif
        <form method="GET" action="{{ route('super-admin.data.penginapan.index') }}" class="mb-4 flex flex-col sm:flex-row gap-2 form-responsive">
            ...
            <div class="table-responsive overflow-x-auto">
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-2 lg:px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Pengelola</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($penginapanList as $index => $penginapan)
                        <tr>
                            ...
                            {{ ($penginapanList->currentPage() - 1) * $penginapanList->perPage() + $index + 1 }}</td>
                            <td class="px-2 lg:px-4 py-2 text-xs lg:text-sm">{{ $penginapan->nama }}</td>
                            <td class="px-2 lg:px-4 py-2 text-xs lg:text-sm">{{ $penginapan->jenis }}</td>
                            <td class="px-2 lg:px-4 py-2 text-xs lg:text-sm">{{ $penginapan->nama_pengelola }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-4 py-8 text-center text-gray-500 text-sm lg:text-base">Belum ada data penginapan.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
