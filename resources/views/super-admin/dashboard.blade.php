        ...
        <div id="profilContent" class="dashboard-content hidden">
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mt-5 space-y-12 max-w-5xl mx-auto px-4">
                    ...
                    <!-- Fungsi -->
                    <div
                        class="relative overflow-hidden rounded-2xl border border-emerald-100 bg-gradient-to-br from-white to-emerald-50/60 shadow-xl mb-8">
                        ...
                        <div class="relative p-8">
                            <div class="flex items-center gap-3 mb-6">
                                <div
                                    class="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-tr from-emerald-500 to-teal-500 text-white shadow-md">
                                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M7 13V9a5 5 0 0110 0v4"></path>
                                    </svg>
                                </div>
                            ...
                            <div class="bg-white/60 backdrop-blur rounded-xl p-4 border border-emerald-100">
                                <ul class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    <!-- 1 -->
                                    <li
                                        class="flex items-start gap-4 rounded-xl border border-gray-100 bg-white/70 p-4 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
                                        <span
                                            class="inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white text-xs font-bold ring-2 ring-white shadow">
                                            1
                                        </span>
                                        <p class="text-gray-700 leading-relaxed">
                                            Penyiapan pelaksanaan koordinasi penyusunan rencana strategis dan rencana kerja
                                            tahunan P4GN di bidang pemberantasan dalam wilayah Provinsi;
                                        </p>
                                    </li>
                                    ...
                                    <li
                                        ...
                                        <p class="text-gray-700 leading-relaxed">
                                            ...
                                            berasal dari tindak pidana narkotika dalam wilayah Provinsi;
                                        </p>
                                    </li>
                                    ...
                                    <!-- 9 -->
                                    <li
                                        class="flex items-start gap-4 rounded-xl border border-gray-100 bg-white/70 p-4 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md md:col-span-2">
                                        <span
                                            class="inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white text-xs font-bold ring-2 ring-white shadow">
                                            9
                                        </span>
