<!-- Tab Data Kecamatan NIK Content -->
<div id="dataKecamatanNikContent" class="dashboard-content hidden">
    <div class="bg-white rounded-lg shadow-lg pb-2">
        <div class="px-4 lg:px-6 pb-2 border-b border-gray-200">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    <h3 class="text-base lg:text-lg font-semibold text-gray-900">Data Kasus per Kecamatan (Berdasarkan NIK)</h3>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @if (isset($dataKecamatanNik) && count($dataKecamatanNik) > 0)
                        @foreach ($dataKecamatanNik as $index => $item)
