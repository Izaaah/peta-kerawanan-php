            ...
            <div class="p-6">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center">
                            <div class="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center">
                                <span
                                    class="text-sm font-medium text-blue-600">{{ substr(auth()->user()->name, 0, 2) }}</span>
                            </div>
                            <div class="ml-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                    ...
                    <div class="bg-purple-50 p-4 rounded-lg border border-purple-200">
                        ...
                        <p class="text-2xl font-bold text-purple-600">
                            {{ auth()->user()->created_at ? auth()->user()->created_at->format('d M Y') : 'N/A' }}</p>
                    ...
                    <div class="bg-orange-50 p-4 rounded-lg border border-orange-200">
                        ...
                        <p class="text-2xl font-bold text-orange-600">
                            {{ auth()->user()->updated_at ? auth()->user()->updated_at->format('d M Y') : 'N/A' }}</p>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <a href="{{ route('peta-penyalahgunaan.domisili') }}"
                            class="flex items-center p-3 bg-white rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
