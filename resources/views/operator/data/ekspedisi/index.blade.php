        ...
        <div class="bg-white shadow rounded p-6">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($ekspedisiList as $index => $ekspedisi)
                        <tr>
                            <td class="px-4 py-2">{{ $ekspedisiList->firstItem() + $index }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-4 py-2 text-center text-gray-500">Belum ada data ekspedisi.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
