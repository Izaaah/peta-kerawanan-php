...
<div class="container mx-auto py-8 px-2">
    ...
    <div id="inputCardGrid" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-8">
        ...
        <a href="{{ route('admin.input.individu') }}" class="block group">
        ...
        <a href="{{ route('admin.data.lsm.create') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-emerald-400">
        ...
        <a href="{{ route('admin.data.medsos.create') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-emerald-400">
        ...
        <a href="{{ route('admin.data.vape.create') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-emerald-400">
        ...
        <a href="{{ route('admin.data.farmasi.create') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-emerald-400">
        ...
        <a href="{{ route('admin.data.rutanlapas.create') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-emerald-400">
        ...
        <a href="{{ route('admin.data.objekvital.create') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-emerald-400">
        ...
        <a href="{{ route('admin.data.penggiat.create') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-emerald-400">
        ...
        <a href="{{ route('admin.data.lrehab.create') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-emerald-400">
        ...
        <!-- Card: Data Ekspedisi -->
        <a href="{{ route('admin.data.ekspedisi.create') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-emerald-400">
        ...
        <a href="{{ route('admin.data.transportasi.create') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-emerald-400">
        ...
        <a href="{{ route('admin.data.penginapan.create') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-emerald-400">
        ...
        <a href="#" class="block group opacity-50 cursor-not-allowed">
            <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-emerald-400">
        ...
        <a href="{{ route('admin.data.thm.create') }}" class="block group">
            <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-xl transition flex flex-col items-center text-center border border-transparent hover:border-emerald-400">
