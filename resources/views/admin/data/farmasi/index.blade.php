...
@section('content')
    ...
    <div class="container mx-auto px-4 py-3">
        ...
        <form method="GET" action="{{ route('admin.data.farmasi.index') }}" class="mb-4 flex gap-2 form-responsive">
        ...
        <div class="bg-white shadow rounded p-3 lg:p-6 card-responsive">
            <div class="table-responsive">\n                <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-2 text-center text-gray-500">Belum ada data farmasi.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>\n            </div>
