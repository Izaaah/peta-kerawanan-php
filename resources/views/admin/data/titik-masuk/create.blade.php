...
@section('content')
    <div class="mx-auto px-4 py-3">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.data.titik-masuk.index') }}"
            ...
            <div class="order-2 lg:order-1 lg:col-span-2">
                <form action="{{ route('admin.data.titik-masuk.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="bg-white shadow rounded p-6 space-y-4">
                        ...
                        <div>
                            <label for="provinsi" class="block text-sm font-medium text-black  ">Provinsi <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div id="wilayah-jatim">
                            <div>
                                <label for="kabupaten" class="block text-sm font-medium text-black   mb-1">Kabupaten <span
                                        class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label for="kecamatan" class="block text-sm font-medium text-black   mb-1">Kecamatan <span
                                        class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label for="kelurahan" class="block text-sm font-medium text-black   mb-1">Kelurahan/Desa
                    ...
                    <div class="bg-white shadow rounded p-6">
                        ...
                        <div class="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('admin.data.titik-masuk.template') }}"
                        ...
                        <form action="{{ route('admin.data.titik-masuk.import') }}" method="POST"
