...
@section('content')
    ...
    <div class="mx-auto px-4 py-3">
        ...
        <form method="GET" action="{{ route('admin.data.lrehab.index') }}" class="mb-4 flex gap-2 form-responsive">
            <input type="text" name="q" value="{{ request('q') }}"
                placeholder="Cari nama, nama ketua, no HP, jenis..." class="border rounded px-3 py-2 w-full text-sm lg:text-base" />
                    ...
                    @forelse($lrehabList as $i => $lrehab)
                        <tr>
                            ...
                            <td class="px-1 py-2 flex gap-1 lg:gap-2 justify-center">
                                ...
                                <form action="{{ route('admin.data.lrehab.destroy', $lrehab->id) }}" method="POST"
