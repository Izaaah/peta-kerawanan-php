...
@section('content')
    <div class="mx-auto px-4 py-3">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-semibold text-gray-800">Edit Lembaga Rehabilitasi</h1>
                <p class="text-sm text-gray-500">Form untuk edit data lembaga rehabilitasi</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-9xl mx-auto">
            <div class="order-2 lg:order-1 lg:col-span-2">
                <form action="{{ route('admin.data.lrehab.update', $lrehab->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    <div class="bg-white shadow rounded p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <select name="jenis_lrehab" id="jenis_lrehab" required
                                ...
                                <option value="LRIP"
                                    {{ old('jenis_lrehab', $lrehab->jenis_lrehab) == 'LRIP' ? 'selected' : '' }}>LRIP
                                    (Lembaga
                                    Rehabilitasi Instansi Pemerintah)</option>
                                <option value="LRKM"
                                    {{ old('jenis_lrehab', $lrehab->jenis_lrehab) == 'LRKM' ? 'selected' : '' }}>LRKM
                                    (Lembaga
                        ...
                        <div>
                            ...
                            <input type="text" id="nama" name="nama" value="{{ old('nama', $lrehab->nama) }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="nama_ketua" name="nama_ketua"
                                value="{{ old('nama_ketua', $lrehab->nama_ketua ?? '') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                required>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="provinsi" id="provinsi" required
                                ...
                                <option value="Jawa Timur"
                                    {{ old('provinsi', $lrehab->provinsi ?? '') == 'Jawa Timur' ? 'selected' : '' }}>Jawa
                                    Timur</option>
                                <option value="lainnya"
                                    {{ old('provinsi', $lrehab->provinsi ?? '') == 'lainnya' ? 'selected' : '' }}>Lainnya
                                </option>
                            </select>
                        </div>
                        ...
                        <div id="wilayah-jatim">
                                    ...
                                    @if (isset($kabupatenList))
                                        @foreach ($kabupatenList as $kabupaten)
                                            <option value="{{ $kabupaten }}"
                                                {{ old('kabupaten', $lrehab->kabupaten ?? '') == $kabupaten ? 'selected' : '' }}>
                                                {{ $kabupaten }}
                                            </option>
                                        @endforeach
                                    @endif
                            ...
                            <div>
                                ...
                                <select name="kecamatan" id="kecamatan"
                                    ...
                                    @if (isset($lrehab->kecamatan) && $lrehab->kecamatan)
                                        <option value="{{ $lrehab->kecamatan }}" selected>{{ $lrehab->kecamatan }}
                                        </option>
                                    @endif
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="kelurahan" id="kelurahan"
                                    ...
                                    @if (isset($lrehab->kelurahan) && $lrehab->kelurahan)
                                        <option value="{{ $lrehab->kelurahan }}" selected>{{ $lrehab->kelurahan }}
                                        </option>
                                    @endif
                                </select>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="provinsi_lain" id="provinsi_lain"
                                        ...
                                        value="{{ old('provinsi_lain', $lrehab->provinsi_lain ?? '') }}">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="kabupaten_lain"
                                        ...
                                        value="{{ old('kabupaten_lain', $lrehab->kabupaten_lain ?? '') }}">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="kecamatan_lain"
                                        ...
                                        value="{{ old('kecamatan_lain', $lrehab->kecamatan_lain ?? '') }}">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="kelurahan_lain"
                                        ...
                                        value="{{ old('kelurahan_lain', $lrehab->kelurahan_lain ?? '') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" required
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Masukkan alamat lengkap (Jalan, RT/RW, dll)">{{ old('alamat', $lrehab->alamat ?? '') }}</textarea>
                        </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    <input type="checkbox" name="sertifikasi[]" value="IPWL" id="ipwl"
                                        class="mr-2"
                                        {{ in_array('IPWL', old('sertifikasi', $lrehab->sertifikasi ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="sertifikasi[]" value="SNI_Nasional" id="sni_nasional"
                                        class="mr-2"
                                        {{ in_array('SNI_Nasional', old('sertifikasi', $lrehab->sertifikasi ?? [])) ? 'checked' : '' }}>
                                    ...
                                    <input type="text" name="nomor_sni_nasional" id="nomor_sni_nasional"
                                        ...
                                        value="{{ old('nomor_sni_nasional', $lrehab->nomor_sni_nasional ?? '') }}"
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="sertifikasi[]" value="SNI_Reguler" id="sni_reguler"
                                        class="mr-2"
                                        {{ in_array('SNI_Reguler', old('sertifikasi', $lrehab->sertifikasi ?? [])) ? 'checked' : '' }}>
                                    ...
                                    <input type="text" name="nomor_sni_reguler" id="nomor_sni_reguler"
                                        placeholder="Nomor Sertifikat"
                                        value="{{ old('nomor_sni_reguler', $lrehab->nomor_sni_reguler ?? '') }}"
                                        class="ml-4 mt-1 block w-1/2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            kecamatanSelect.addEventListener('change', function() {
                ...
                if (selectedKabupaten && selectedKecamatan) {
                    loadKelurahan(selectedKabupaten, selectedKecamatan);
                } else {
                    kelurahanSelect.innerHTML = '<option value="">Pilih Kelurahan/Desa</option>';
                }
            });

            // Initialize form state and load existing data
            const initialProvinsi = provinsiSelect.value;
            if (initialProvinsi === 'Jawa Timur') {
                wilayahJatim.classList.remove('hidden');
                // Load kecamatan if kabupaten is already selected
                const selectedKabupaten = kabupatenSelect.value;
                if (selectedKabupaten) {
                    loadKecamatan(selectedKabupaten);
                }
            ...
            function loadKecamatan(kabupaten) {
                if (kabupaten) {
                    fetch(`/api/kecamatan-list?kabupaten=${encodeURIComponent(kabupaten)}`)
                        ...
                        .then(data => {
                            ...
                            data.forEach(kecamatan => {
                                ...
                                // Check if this kecamatan matches the existing data
                                if (kecamatan === '{{ $lrehab->kecamatan ?? '' }}') {
                                    option.selected = true;
                                }
                                kecamatanSelect.appendChild(option);
                            });

                            // Load kelurahan if kecamatan is already selected
                            const selectedKecamatan = kecamatanSelect.value;
                            if (selectedKecamatan) {
                                loadKelurahan(kabupaten, selectedKecamatan);
                            }
                        })
                        .catch(error => {
            ...
            function loadKelurahan(kabupaten, kecamatan) {
                    ...
                    fetch(
                        ...
                        .then(data => {
                            ...
                            data.forEach(kelurahan => {
                                ...
                                // Check if this kelurahan matches the existing data
                                if (kelurahan === '{{ $lrehab->kelurahan ?? '' }}') {
                                    option.selected = true;
                                }
                        ...
                        .catch(error => {
                            ...
                            kelurahanSelect.innerHTML = '<option value="">Error loading kelurahan</option>';
                        });
                }
            }
        });
