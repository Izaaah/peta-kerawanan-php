...
<div class="mx-auto px-4 py-3">
    <div class="bg-white rounded shadow p-6">
        ...
        <form action="{{ route('admin.data.lrehab.update', $lrehab->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="flex gap-2 mt-6">
                ...
                <a href="{{ route('admin.data.lrehab.index') }}" class="bg-gray-300 text-gray-800 px-4 py-2 rounded hover:bg-gray-400">Batal</a>
            </div>
        </form>
    </div>
</div>
