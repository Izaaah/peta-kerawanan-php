            ...
            <div class="order-2 lg:order-1 lg:col-span-2">
                ...
                <form action="{{ route('admin.data.ekspedisi.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="bg-white shadow rounded p-6 space-y-4">
                        ...
                        <div>
                            <label for="nama" class="block text-sm font-medium text-gray-700">Nama Ekspedisi <span
                        ...
                        <div>
                            <label for="manager" class="block text-sm font-medium text-gray-700">Manager <span
                                    class="text-red-500">*</span></label>
                    ...
                    <div class="bg-white shadow rounded p-6">
                        ...
                        <div class="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('admin.data.ekspedisi.template') }}"
                        ...
                        <form action="{{ route('admin.data.ekspedisi.import') }}" method="POST"
