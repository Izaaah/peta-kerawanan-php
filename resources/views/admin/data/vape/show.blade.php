...
<div class="max-w-7xl mx-auto pt-1 pb-2 px-1">
    <div class="bg-white rounded shadow p-6">
        ...
        <div class="flex gap-2 mt-6">
            <a href="{{ route('admin.data.vape.edit', $vape->id) }}" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">Edit</a>
            <a href="{{ route('admin.data.vape.index') }}" class="bg-gray-300 text-gray-800 px-4 py-2 rounded hover:bg-gray-400">Kembali</a>
        </div>
    </div>
</div>
@endsection
