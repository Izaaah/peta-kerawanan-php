            ...
            <div class="order-2 lg:order-1 lg:col-span-2">
                <form action="{{ route('admin.data.objekvital.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="bg-white shadow rounded p-6 space-y-4">
                        <h6 class="text-lg font-semibold text-primary"><i class="fas fa-landmark mr-2"></i>Data Objek Vital
                        </h6>
                        <div>
                            <label for="jenis_objek" class="block text-sm font-medium text-gray-700">Jenis Objek Vital <span
                                    class="text-red-500">*</span></label>
                            <select id="jenis_objek" name="jenis_objek"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                required>
                                <option value="">Pilih Jenis Objek Vital</option>
                                <option value="Industri" {{ old('jenis_objek') == 'Industri' ? 'selected' : '' }}>Industri
                                </option>
                                <option value="Pertambangan dan Energi"
                                    {{ old('jenis_objek') == 'Pertambangan dan Energi' ? 'selected' : '' }}>Pertambangan dan
                                    Energi</option>
                                <option value="Perhubungan" {{ old('jenis_objek') == 'Perhubungan' ? 'selected' : '' }}>
                                    Perhubungan</option>
                                <option value="Instalasi dan Bangunan"
                                    {{ old('jenis_objek') == 'Instalasi dan Bangunan' ? 'selected' : '' }}>Instalasi dan
                                    Bangunan</option>
                                <option value="Perbankan dan Keuangan"
                                    {{ old('jenis_objek') == 'Perbankan dan Keuangan' ? 'selected' : '' }}>Perbankan dan
                                    Keuangan</option>
                                <option value="Lembaga Negara"
                                    {{ old('jenis_objek') == 'Lembaga Negara' ? 'selected' : '' }}>Lembaga Negara</option>
                            </select>
                            @error('jenis_objek')
                        ...
                        <div>
                            <label for="nama_objek" class="block text-sm font-medium text-gray-700">Nama Objek <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label for="nama_manager" class="block text-sm font-medium text-gray-700">Nama Manager <span
                                    class="text-red-500">*</span></label>
                            <input type="text" id="nama_manager" name="nama_manager" value="{{ old('nama_manager') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                required>
                        </div>
                        <div>
