            ...
            <div class="order-2 lg:order-1 lg:col-span-2">
                <form action="{{ route('admin.data.penggiat.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="bg-white shadow rounded p-6 space-y-4">
                        <h6 class="text-lg font-semibold text-primary"><i class="fas fa-user-friends mr-2"></i>Data Penggiat
                            Narkotika</h6>
                        <div>
                    ...
                    <div class="bg-white shadow rounded p-6">
                        ...
                        <div class="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('admin.data.penggiat.template') }}"
                        ...
                        <form action="{{ route('admin.data.penggiat.import') }}" method="POST"
