    ...
    <div class="mx-auto px-4 py-3">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex gap-2">
                <a href="{{ route('admin.data.penggiat.create') }}"
        ...
        <form method="GET" action="{{ route('admin.data.penggiat.index') }}" class="mb-4 flex gap-2 form-responsive">
            ...
            <div class="table-responsive">\n                <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Nama Penggiat</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($penggiatList as $i => $penggiat)
                        <tr>
                            <td class="px-4 py-2 text-center">{{ $penggiatList->firstItem() + $i }}</td>
                            <td class="px-4 py-2">{{ $penggiat->nama }}</td>
                            <td class="px-4 py-2">{{ $penggiat->alamat }}</td>
                            <td class="px-4 py-2">{{ $penggiat->no_hp }}</td>
                            <td class="px-4 py-2">{{ $penggiat->kegiatan ?? '-' }}</td>
                            <td class="px-4 py-2 flex gap-2 justify-center">
                                <a href="{{ route('admin.data.penggiat.show', $penggiat->id) }}"
                                ...
                                <a href="{{ route('admin.data.penggiat.edit', $penggiat->id) }}"
                                ...
                                <form action="{{ route('admin.data.penggiat.destroy', $penggiat->id) }}" method="POST"
