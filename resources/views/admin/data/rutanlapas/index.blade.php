...
@section('content')
    ...
    <div class="mx-auto px-4 py-1">
        <div class="flex justify-between items-center">
            ...
            <div class="gap-6">
                <a href="{{ route('admin.data.rutanlapas.create') }}"
        ...
        <form method="GET" action="{{ route('admin.data.rutanlapas.index') }}" class="mb-4 flex gap-2" id="searchForm">
            <input type="text" name="q" value="{{ request('q') }}" placeholder="Cari nama napi, lapas, status..."
                class="border rounded px-3 py-2 w-full text-sm lg:text-base" id="searchInput" />
            ...
            <div class="table-responsive">\n                <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($rutanlapasList as $i => $rutanlapas)
                        <tr>
                            <td class="px-4 py-2 text-center">{{ $rutanlapasList->firstItem() + $i }}</td>
                            <td class="px-4 py-2">{{ $rutanlapas->nik ?? '-' }}</td>
                            ...
                            <td class="px-4 py-2 flex gap-2 justify-center">
                                <a href="{{ route('admin.data.rutanlapas.show', $rutanlapas->id) }}"
                                ...
                                <a href="{{ route('admin.data.rutanlapas.edit', $rutanlapas->id) }}"
                                ...
                                <form action="{{ route('admin.data.rutanlapas.destroy', $rutanlapas->id) }}" method="POST"
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-2 text-center text-gray-500">Belum ada data Jaringan
                                Rutan/Lapas.</td>
                        </tr>
                    @endforelse
                </tbody>
