...
<div class="container mx-auto px-1 pt-1 pb-2 max-w-7xl">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.data.transportasi.create') }}" class="inline-flex items-center px-8 py-2 text-sm font-medium text-white bg-blue-600 rounded hover:bg-blue-700">
