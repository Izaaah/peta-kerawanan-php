...
<div class="max-w-4xl mx-auto py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.data.transportasi.edit', $transportasi->id) }}" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">Edit</a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-gray-900">{{ $transportasi->posisi ?? '-' }}</p>
                    </div>
            ...
            <div>
                ...
                <div class="bg-gray-50 p-4 rounded">
                    <p class="text-gray-900 whitespace-pre-wrap">{{ $transportasi->lokasi }}</p>
                </div>
            </div>
        </div>
