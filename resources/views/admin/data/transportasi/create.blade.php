...
@section('content')
    <div class="mx-auto px-4 py-3">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-semibold text-gray-800">Tambah Jasa Transportasi</h1>
                <p class="text-sm text-gray-500">Form untuk input data jasa transportasi</p>
            </div>
            ...
            <div class="order-2 lg:order-1 lg:col-span-2">
                <form action="{{ route('admin.data.transportasi.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="bg-white shadow rounded p-6 space-y-4">
                        <h6 class="text-lg font-semibold text-primary"><i class="fas fa-bus mr-2"></i>Data Jasa
                            Transportasi</h6>
                        <div>
                            <label for="jenis_transportasi" class="block text-sm font-medium text-gray-700">Jenis
                                Jasa Transportasi <span class="text-red-500">*</span></label>
                            <select name="jenis_transportasi" id="jenis_transportasi"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                required>
                                <option value="">Pilih Jenis Jasa Transportasi</option>
                        ...
                        <div>
                            <label for="nama_pihak" class="block text-sm font-medium text-gray-700">Nama Jasa Transportasi
                        ...
                        <div id="wilayah-lainnya" class="hidden">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Provinsi</label>
                                    <input type="text" name="provinsi_lain" value="{{ old('provinsi_lain') }}"
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Kabupaten</label>
                                    <input type="text" name="kabupaten_lain" value="{{ old('kabupaten_lain') }}"
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Kecamatan</label>
                                    <input type="text" name="kecamatan_lain" value="{{ old('kecamatan_lain') }}"
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Kelurahan/Desa</label>
                                    <input type="text" name="kelurahan_lain" value="{{ old('kelurahan_lain') }}"
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                </div>
                            </div>
                        </div>
                        <div>
                            ...
                            <textarea name="alamat" id="alamat" rows="3"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required>{{ old('alamat') }}</textarea>
                            @error('alamat')
                                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            <label for="nama_manager" class="block text-sm font-medium text-gray-700">Nama
                                Kepala/Manager</label>
                            <input type="text" name="nama_manager" id="nama_manager" value="{{ old('nama_manager') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            @error('nama_manager')
                                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="bg-white shadow rounded p-6">
                        ...
                        <div class="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('admin.data.transportasi.template') }}"
                        ...
                        <form action="{{ route('admin.data.transportasi.import') }}" method="POST"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            provinsi.addEventListener('change', function() {
                if (this.value === 'Jawa Timur') showJatim();
